...
namespace ZeraldotNet.TestLibBitTorrent
{
    ...
    public class TestBEncode
    {
        ...
        {
            //Test1整数
            ListNode lh1 = (ListNode)BEncode.Decode("li0ei1ei2ee");
            ...
            //Test2字节数组
            ListNode lh2 = (ListNode)BEncode.Decode("l3:abc2:xye");
            ...
            //Test3空字节数组
            ListNode lh3 = (ListNode)BEncode.Decode("l0:0:0:e");
            ...
            //Test4字节数组与整数
            ListNode lh4 = (ListNode)BEncode.Decode("ll5:Alice3:Bobeli2ei3eee");
            ...
            //Test5空列表
            ListNode lh5 = (ListNode)BEncode.Decode("le");
        ...
        {
            //Test1整数
            DictNode dh1 = (DictNode)BEncode.Decode("d3:agei25ee");
            Assert.AreEqual(((IntNode)dh1["age"]).LongValue, 25);

            //Test2字节数组
            DictNode dh2 = (DictNode)BEncode.Decode("d3:agei25e5:color4:bluee");
            ...
            //Test3字节数组与整数
            DictNode dh3 = (DictNode)BEncode.Decode("d8:spam.mp3d6:author5:Alice6:lengthi1048576eee");
            ...
            //Test4空字典
            DictNode dh4 = (DictNode)BEncode.Decode("de");
