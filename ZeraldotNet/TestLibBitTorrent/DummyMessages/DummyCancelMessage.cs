...
{
    public class DummyCancelMessage : DummyHaveMessage
    {
        ...
        /// 构造函数
        /// </summary>
        public DummyCancelMessage(DummyEncryptedConnection encryptedConnection, DummyConnection connection, DummyConnecter connecter)
        ...
        public DummyCancelMessage(int index, int begin, int length)
            : base(index)
        {
            this.begin = begin;
            this.length = length;
